YUI().use('node', 'json', 'io-xdr', 'io-form', function(Y) {
    ...
    Y.log('Found node.. Setting style');
		...
		Y.on('io:xdrReady', function() {
				var uri = 'http://www.makers-online.co.uk:3001/projects/visitor_blogroll/api/get_feeds?host=' + escape(window.location.hostname) + '&path=' + escape(window.location.pathname);
				Y.log(uri);				
		...
		formNode.on('submit', function(e) {
				var uri = 'http://www.makers-online.co.uk:3001/projects/visitor_blogroll/api/add_feed?host=' + escape(window.location.hostname) + '&path=' + escape(window.location.pathname);
				Y.log(e);
